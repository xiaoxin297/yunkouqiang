...
<link href="${root}/resources/admin/css/jquery.gritter.css" rel="stylesheet" type="text/css" />
<link href="${root}/resources/admin/css/daterangepicker.css" rel="stylesheet" type="text/css" />
<link href="${root}/resources/admin/css/fullcalendar.css" rel="stylesheet" type="text/css" />
<link href="${root}/resources/admin/css/jqvmap.css" rel="stylesheet" type="text/css" media="screen" />
<link href="${root}/resources/admin/css/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen" />
...
<body class="page-header-fixed">
	...
	<div class="header navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			...
			<div class="container-fluid">
				...
				<a href="javascript:;" class="btn-navbar collapsed" data-toggle="collapse" data-target=".nav-collapse"> <img src="${root}/resources/admin/image/menu-toggler.png" alt="" />
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown" id="header_inbox_bar"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-envelope"></i> <span class="badge">5</span>
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li><a href="inbox.html?a=view"> <span class="photo"><img src="${root}/resources/admin/image/avatar2.jpg" alt="" /></span> <span class="subject"> <span class="from">Lisa Wong</span> <span
							...
							<li><a href="inbox.html?a=view"> <span class="photo"><img src="${root}/resources/admin/image/avatar3.jpg" alt="" /></span> <span class="subject"> <span class="from">Richard Doe</span> <span
							...
							<li><a href="inbox.html?a=view"> <span class="photo"><img src="${root}/resources/admin/image/avatar1.jpg" alt="" /></span> <span class="subject"> <span class="from">Bob Nilson</span> <span
					...
					<li class="dropdown user"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img alt="" src="${root}/resources/admin/image/avatar1_small.jpg" /> <span class="username">Bob Nilson</span> <i
	...
	<div class="page-container">
		...
		<div id="sidebar" class="page-sidebar nav-collapse collapse"></div>
					...
					<div class="span12">
						...
						<div class="color-panel hidden-phone">
							...
							<div class="color-mode">
								...
								</label> <label> <span>Header</span> <select class="header-option m-wrap small">
								...
								</label> <label> <span>Sidebar</span> <select class="sidebar-option m-wrap small">
								...
								</label> <label> <span>Footer</span> <select class="footer-option m-wrap small">
							...
							<div class="portlet solid bordered light-grey">
								...
								<div class="portlet-title">
									...
									<div class="tools">
										...
										<div class="btn-group pull-right" data-toggle="buttons-radio">
											...
											<a href="" class="btn mini">Users</a> <a href="" class="btn mini active">Feedbacks</a>
								...
								<div class="portlet-body">
									...
									<div id="site_statistics_loading">
										...
										<img src="${root}/resources/admin/image/loading.gif" alt="loading" />
								...
								<div class="portlet-title">
									...
									<div class="tools">
										...
										<div class="btn-group pull-right" data-toggle="buttons-radio">
											...
											<a href="" class="btn blue mini active">Users</a> <a href="" class="btn blue mini">Orders</a>
								...
								<div class="portlet-title">
									...
									<div class="tools">
										...
										<div class="btn-group pull-right" data-toggle="buttons-radio">
											...
											<a href="" class="btn red mini active"> <span class="hidden-phone">Database</span> <span class="visible-phone">DB</span></a> <a href="" class="btn red mini">Web</a>
																...
																<div class="cont">
																	...
																	<div class="cont-col2">
																		...
																		<div class="desc">
																			...
																			Web server hardware needs to be upgraded. <span class="label label-inverse label-mini">Overdue</span>
																...
																<div class="cont">
																	...
																	<div class="cont-col2">
																		...
																		<div class="desc">
																			...
																			Order #24DOP4 has been rejected. <span class="label label-important label-mini">Take action <i class="icon-share-alt"></i></span>
												...
												<div class="scroller" data-height="290px" data-always-visible="1" data-rail-visible1="1">
													...
													<div class="row-fluid">
														...
														<div class="span6 user-info">
															...
															<img alt="" src="${root}/resources/admin/image/avatar.png" />
								...
								<div class="portlet-body" id="chats">
									...
									<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
										...
										<ul class="chats">
											...
											<li class="in"><img class="avatar" alt="" src="${root}/resources/admin/image/avatar1.jpg" />

												<div class="message">

													<span class="arrow"></span> <a href="#" class="name">Bob Nilson</a> <span class="datetime">at Jul 25, 2012 11:09</span> <span class="body"> Lorem ipsum dolor sit amet, consectetuer
														adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. </span>

												</div></li>

											<li class="out"><img class="avatar" alt="" src="${root}/resources/admin/image/avatar2.jpg" />

												<div class="message">

													<span class="arrow"></span> <a href="#" class="name">Lisa Wong</a> <span class="datetime">at Jul 25, 2012 11:09</span> <span class="body"> Lorem ipsum dolor sit amet, consectetuer
														adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. </span>
											...
											<li class="out"><img class="avatar" alt="" src="${root}/resources/admin/image/avatar3.jpg" />

												<div class="message">

													<span class="arrow"></span> <a href="#" class="name">Richard Doe</a> <span class="datetime">at Jul 25, 2012 11:09</span> <span class="body"> Lorem ipsum dolor sit amet,
														consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. </span>

												</div></li>

											<li class="in"><img class="avatar" alt="" src="${root}/resources/admin/image/avatar3.jpg" />
											...
											<li class="out"><img class="avatar" alt="" src="${root}/resources/admin/image/avatar1.jpg" />
											...
											<li class="out"><img class="avatar" alt="" src="${root}/resources/admin/image/avatar1.jpg" />
												...
												<div class="message">
													...
													<span class="arrow"></span> <a href="#" class="name">Bob Nilson</a> <span class="datetime">at Jul 25, 2012 11:09</span> <span class="body"> Lorem ipsum dolor sit amet, consectetuer
														adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. sed diam nonummy nibh euismod tincidunt ut laoreet. </span>
									...
									<div class="chat-form">
										...
										<div class="btn-cont">
											...
											<span class="arrow"></span> <a href="" class="btn blue icn-only"><i class="icon-ok icon-white"></i></a>
	...
	<script src="${root}/resources/admin/js/jquery.vmap.js" type="text/javascript"></script>

	<script src="${root}/resources/admin/js/jquery.vmap.russia.js" type="text/javascript"></script>

	<script src="${root}/resources/admin/js/jquery.vmap.world.js" type="text/javascript"></script>

	<script src="${root}/resources/admin/js/jquery.vmap.europe.js" type="text/javascript"></script>

	<script src="${root}/resources/admin/js/jquery.vmap.germany.js" type="text/javascript"></script>

	<script src="${root}/resources/admin/js/jquery.vmap.usa.js" type="text/javascript"></script>

	<script src="${root}/resources/admin/js/jquery.vmap.sampledata.js" type="text/javascript"></script>

	<script src="${root}/resources/admin/js/jquery.flot.js" type="text/javascript"></script>

	<script src="${root}/resources/admin/js/jquery.flot.resize.js" type="text/javascript"></script>

	<script src="${root}/resources/admin/js/jquery.pulsate.min.js" type="text/javascript"></script>

	<script src="${root}/resources/admin/js/date.js" type="text/javascript"></script>

	<script src="${root}/resources/admin/js/daterangepicker.js" type="text/javascript"></script>

	<script src="${root}/resources/admin/js/jquery.gritter.js" type="text/javascript"></script>

	<script src="${root}/resources/admin/js/fullcalendar.min.js" type="text/javascript"></script>

	<script src="${root}/resources/admin/js/jquery.easy-pie-chart.js" type="text/javascript"></script>

	<script src="${root}/resources/admin/js/jquery.sparkline.min.js" type="text/javascript"></script>
